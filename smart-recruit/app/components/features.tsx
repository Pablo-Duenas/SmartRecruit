        ...
        <section id="features" className="bg-white py-16 md:py-24 min-h-screen">
            <div className="mx-auto w-full max-w-6xl px-6">
                <div className="text-center">
                    <div className="text-xs font-black tracking-widest text-blue-700">EL PROCESO</div>
                ...
                <div className="mt-12 grid gap-6 md:grid-cols-3">
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-slate-600">
                            Sube tu currículum de forma segura. Nuestros parsers extraen la información con alta precisión.
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-slate-600">
                            Cruzamos tus habilidades con los requisitos del puesto y generamos sugerencias de mejora en tiempo real.
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-slate-600">
                            Descarga tu CV optimizado y compatible con ATS y empieza a postular a mejores oportunidades con confianza.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-14 rounded-3xl border border-blue-100 bg-blue-50/60 p-10 text-center shadow-sm md:p-14">
                    ...
                    <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-slate-600 md:text-base">
                        Anímate a optimizar tu CV con una plataforma impulsada por IA y empieza a postular con ventaja.
                    </p>
                    <div className="mt-7">
                        <a
                            href="#mainContent"
                            className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-7 py-3 text-sm font-extrabold text-white shadow-sm transition hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
                        >
